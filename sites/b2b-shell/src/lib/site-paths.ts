...
type FixedKind = 'about' | 'contact' | 'collections';

const fixedRoutes: Array<{ slug: string; kind: FixedKind }> = [
  { slug: 'about', kind: 'about' },
  { slug: 'about-us', kind: 'about' },
  { slug: 'contact', kind: 'contact' },
  { slug: 'contact-us', kind: 'contact' },
  { slug: 'collections', kind: 'collections' },
  { slug: 'products', kind: 'collections' },
  { slug: 'projects', kind: 'collections' },
];
